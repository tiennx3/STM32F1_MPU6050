 ...
 * @see getMotionDetectionDuration(void)
 * @see MPU6050_RA_MOT_DUR
 */
 ...
 * @see getZeroMotionDetectionThreshold(void)
 * @see MPU6050_RA_ZRMOT_THR
 */
 ...
 * @see getZeroMotionDetectionDuration(void)
 * @see MPU6050_RA_ZRMOT_DUR
 */
 ...
 * @see getMultiMasterEnabled(void)
 * @see MPU6050_RA_I2C_MST_CTRL
 */
 ...
 * @see getWaitForExternalSensorEnabled(void)
 * @see MPU6050_RA_I2C_MST_CTRL
 */
 ...
 * @see getSlaveReadWriteTransitionEnabled(void)
 * @see MPU6050_RA_I2C_MST_CTRL
 */
...
int8_t I2Cdev_readBytes(uint8_t dev_addr, uint8_t reg_addr, uint8_t len, uint8_t *data) {
	...
	err = HAL_I2C_Mem_Read(&I2C_MPU6050,dev_addr,reg_addr,I2C_MEMADD_SIZE_8BIT,data,len,10);
	if(err == HAL_OK)
	{
		return err;
	}
...
int8_t 	I2Cdev_writeBytes(uint8_t dev_addr, uint8_t reg_addr, uint8_t len, uint8_t *data) {
	HAL_StatusTypeDef err = HAL_ERROR;
	err = HAL_I2C_Mem_Write(&I2C_MPU6050,dev_addr,reg_addr,I2C_MEMADD_SIZE_8BIT,data,len,10);
	if(err == HAL_OK)
	{
		return err;
	}
...
int8_t 	I2Cdev_writeWord(uint8_t dev_addr, uint8_t reg_addr, uint16_t data) {
	...
	err= I2Cdev_writeBytes(dev_addr,reg_addr,2,ts_data);
	return err;
}
...
int8_t 	I2Cdev_writeWords(uint8_t dev_addr, uint8_t reg_addr, uint8_t len, uint16_t *data) {
	...
	err= I2Cdev_writeBytes(dev_addr,reg_addr,bytes_num,bytes);
	return err;
}
